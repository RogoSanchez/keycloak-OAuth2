...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _AuthenticationSubscriptionRequested value)?  authenticationSubscriptionRequested,TResult Function( _AuthenticationLogoutPressed value)?  authenticationLogoutPressed,TResult Function( _AuthenticationLoginPressed value)?  loginPressed,TResult Function( _Initialize value)?  initialize,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return authenticationLogoutPressed(_that);case _AuthenticationLoginPressed() when loginPressed != null:
return loginPressed(_that);case _Initialize() when initialize != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _AuthenticationSubscriptionRequested value)  authenticationSubscriptionRequested,required TResult Function( _AuthenticationLogoutPressed value)  authenticationLogoutPressed,required TResult Function( _AuthenticationLoginPressed value)  loginPressed,required TResult Function( _Initialize value)  initialize,}){
final _that = this;
switch (_that) {
...
return authenticationLogoutPressed(_that);case _AuthenticationLoginPressed():
return loginPressed(_that);case _Initialize():
return initialize(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _AuthenticationSubscriptionRequested value)?  authenticationSubscriptionRequested,TResult? Function( _AuthenticationLogoutPressed value)?  authenticationLogoutPressed,TResult? Function( _AuthenticationLoginPressed value)?  loginPressed,TResult? Function( _Initialize value)?  initialize,}){
final _that = this;
switch (_that) {
case _AuthenticationSubscriptionRequested() when authenticationSubscriptionRequested != null:
return authenticationSubscriptionRequested(_that);case _AuthenticationLogoutPressed() when authenticationLogoutPressed != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  authenticationSubscriptionRequested,TResult Function()?  authenticationLogoutPressed,TResult Function()?  loginPressed,TResult Function()?  initialize,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthenticationSubscriptionRequested() when authenticationSubscriptionRequested != null:
return authenticationSubscriptionRequested();case _AuthenticationLogoutPressed() when authenticationLogoutPressed != null:
return authenticationLogoutPressed();case _AuthenticationLoginPressed() when loginPressed != null:
return loginPressed();case _Initialize() when initialize != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  authenticationSubscriptionRequested,required TResult Function()  authenticationLogoutPressed,required TResult Function()  loginPressed,required TResult Function()  initialize,}) {final _that = this;
switch (_that) {
case _AuthenticationSubscriptionRequested():
return authenticationSubscriptionRequested();case _AuthenticationLogoutPressed():
return authenticationLogoutPressed();case _AuthenticationLoginPressed():
return loginPressed();case _Initialize():
return initialize();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  authenticationSubscriptionRequested,TResult? Function()?  authenticationLogoutPressed,TResult? Function()?  loginPressed,TResult? Function()?  initialize,}) {final _that = this;
switch (_that) {
case _AuthenticationSubscriptionRequested() when authenticationSubscriptionRequested != null:
return authenticationSubscriptionRequested();case _AuthenticationLogoutPressed() when authenticationLogoutPressed != null:
return authenticationLogoutPressed();case _AuthenticationLoginPressed() when loginPressed != null:
...
class _AuthenticationLoginPressed implements AuthEvent {
  const _AuthenticationLoginPressed();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthenticationLoginPressed);
}
...
@override @useResult
$Res call({
 AuthenticationStatus status, UserModel user
});
